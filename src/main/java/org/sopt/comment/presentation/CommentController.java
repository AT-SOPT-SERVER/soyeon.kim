...
import org.sopt.comment.presentation.dto.request.UpdateCommentRequest;
...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<GetAllCommentsResponse>> getAllComments(
        ...
        GetAllCommentsServiceResponse serviceResponse = commentQueryService.getAllComments(userId, postId, page, size);
    ...
    public ResponseEntity<ApiResponse<Void>> updateComment(
        ...
        UpdateCommentServiceRequest serviceRequest = toUpdateCommentServiceRequest(userId, commentId, request);
